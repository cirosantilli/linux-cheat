...
The standard files shall not be discussed here since they can be accessed from userspace
without kernel internals understanding.

Only the kernal internal point of view shall be discussed here, for example how
to create such special files.
